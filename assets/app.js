...
$(() => {
  ...
  function hiddenProductGalleryNav(variant) {
    $('.product_gallery_nav .gallery-cell').each(function(){
      if($(this).attr('alt') != variant) {
...
$(document)
  .on('shopify:section:load', function(e){
    ...
    if ($parentSection.hasClass('shopify-section--featured-product') || $parentSection.hasClass('shopify-section--quickshop')) {
      window.productPage.init();
      window.productPage.runOptionSelector();
      window.videoFeature.init();
      window.productPage.productSwatches();
